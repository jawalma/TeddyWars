...
if ((l71C5396F_0 > 0))
{
	...
	draw_sprite(s_clueimg_kitchen02, image_index, view_wview * 0.5, view_hview * 0.33);
	draw_text_ext(view_wview * 0.5, view_hview * 0.65, string("A family photo is hung up on the fridge. They seem very happy."), 40, 1000);
