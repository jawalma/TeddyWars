...
if ((l71C5396F_0 > 0))
{
	...
	draw_sprite(s_comic_image, image_index, view_wview * 0.5, view_hview * 0.33);
	draw_text_ext(view_wview * 0.5, view_hview * 0.65, string("Looks Like Some Sort of Kids Comicbook...I Wonder if This Could Help Me Out in Any Way"), 40, 1000);
