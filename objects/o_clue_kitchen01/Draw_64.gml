...
if ((l71C5396F_0 > 0))
{
	...
	draw_sprite(s_clueimg_kitchen01, image_index, view_wview * 0.5, view_hview * 0.33);
	draw_text_ext(view_wview * 0.5, view_hview * 0.65, string("There's a huge stain on the kitchen floor. It looks old."), 40, 1000);
