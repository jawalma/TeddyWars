...
if (position_meeting(mouse_x, mouse_y, id)){
	...
	("A warriors head band that gives you immense strength. Use it to deal double damage to enemies and deal with large obstacles."), 40, 600);
	}
