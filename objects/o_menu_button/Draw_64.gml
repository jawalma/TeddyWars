...
if (item_id=="comic_01"){
	...
	draw_sprite(s_comic_image, image_index, view_wview * 0.7, view_hview * 0.33);
	draw_text_ext(view_wview * 0.7, view_hview * 0.65, string("This looks like some sort of kids comic book...might be helpful in someway."), 40, 600);
	}
}